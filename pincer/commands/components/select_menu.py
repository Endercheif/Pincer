...
class SelectOption(APIObject):
    ...
    description: :class:`~pincer.utils.types.APINullable`\\[:class:`str`]
        An additional description of the option, max 100 characters.
    emoji: :class:`~pincer.utils.types.APINullable`\\[:class:`~pincer.objects.message.emoji.Emoji`]
        ``id``, ``name``, and ``animated``.
    default: :class:`~pincer.utils.types.APINullable`\\[:class:`bool`]
...
class SelectMenu(_Component):
    ...
    custom_id: :class:`str`
        ...
        max 100 characters.
    options: :class:`list`\\[:class:`~pincer.commands.components.select_menu.SelectOption`]
    ...
    def with_options(self, *options: SelectOption) -> SelectMenu:
        ...
        \\*options : :class:`~pincer.commands.components.SelectOption`
